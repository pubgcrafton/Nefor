...
class TestMod(loader.Module):
    ...
    strings_ru = {
        ...
        "results_ping": "▫️ <b>Скорость отклика:</b> <code>{}</code> <b>ms</b>\n▫️ <b>Прошло с последней перезагрузки: {}</b>",
    ...
    async def client_ready(self, client, db):
        ...
        chat, is_new = await utils.asset_channel(
            ...
            silent=True,
            avatar="https://github.com/NinoZOOM/assets/raw/main/Nino-logs.png",
        )
