...
@loader.tds
class NinoConfigMod(loader.Module):
    ...
    strings_ru = {
        ...
        "_cls_doc": "Интерактивный конфигуратор Nino",
        ...
        "typehint": "🙄 <b>Должно быть {}</b>",
        "set": "поставить",
        "set_default_btn": "😇 Значение по умолчанию",
