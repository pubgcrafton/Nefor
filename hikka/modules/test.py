...
class TestMod(loader.Module):
    ...
    strings = {
        ...
        "logs_caption": "▫️ <b>Nino logs with verbosity </b><code>{}</code>\n\n▫️‍ <b>Nino version: {}.{}.{}</b>{}\n▫️ <b>Uptime: {}</b>\n<b>{}</b>\n\n<b>{}</b>\n\n<b>{} NoNick</b>\n<b>{} Grep</b>\n<b>{} InlineLogs</b>",
    ...
    strings_ru = {
        ...
        "logs_filename": "nino-logs.html",
        "logs_caption": "🌐 <b>Логи Nino уровня </b><code>{}</code>\n\n▫️‍ <b>Версия Nino: {}.{}.{}</b>{}\n▫️ <b>Uptime: {}</b>\n<b>{}</b>\n\n<b>{}</b>\n\n<b>{} NoNick</b>\n<b>{} Grep</b>\n<b>{} InlineLogs</b>",
    ...
    async def client_ready(self, client, db):
        ...
        chat, is_new = await utils.asset_channel(
            self._client,
            "nino-logs",
            "🌐 Your Nino logs will appear in this chat",
            silent=True,
            avatar="https://imgur.com/9xuJQxi,
        )
