...
class UpdaterMod(loader.Module):
    ...
    strings_ru = {
        ...
        "success": "▫️ <i>Перезагрузка успешна! {}</i>\n<i>▪️ Но модули еще загружаются...</i>\n<i>▫️ Перезагрузка заняла {} сек</i>",
        "full_success": "▪️ <i>Юзербот полностью загружен! {}</i>\n<i>▪️ Полная перезагрузка заняла {} сек</i>",
